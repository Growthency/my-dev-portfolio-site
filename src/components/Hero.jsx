    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          >
            <img
              src="https://avatars.githubusercontent.com/u/143309391?v=4"
              alt="Injamul Haque"
          ...
          <div className="space-y-4">
            ...
            >
              Hi, I'm <span className="text-blue-400">Injamul Haque</span>
            </motion.h1>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              Specialized in React, Node.js, and mern-stack development.
            </motion.p>
          </div>
          ...
          >
            {[
              ...
              { icon: FiLinkedin, href: "linkedin.com/in/ninjamul-haque", label: "LinkedIn" },
