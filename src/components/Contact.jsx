...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: FiMail,
      title: "Email",
      info: "itsinjamul@gmail.com",
      link: "mailto:itsinjamul@gmail.com"
    },
    {
      icon: FiPhone,
      title: "Phone",
      info: "+880 1683 239856",
      link: "tel:+8801683239856"
    },
    {
      icon: FiMapPin,
      title: "Location",
  ...
  const socialLinks = [
    { icon: FiGithub, href: "https://github.com/Growthency", label: "GitHub" },
    { icon: FiLinkedin, href: "https://www.linkedin.com/in/ninjamul-haque", label: "LinkedIn" },
    { icon: FiMail, href: "mailto:itsinjamul@gmail.com", label: "Email" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                Don't like forms? Send me an email. 👋 Or you can find me on social media.
              </p>
            </div>
        ...
        >
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            I'm available for freelance work and exciting opportunities. Let's discuss your project and bring your ideas to life!
          </p>
          <motion.a
