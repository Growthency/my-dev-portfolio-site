...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "A comprehensive social media management dashboard with analytics, post scheduling, and engagement tracking. Features responsive design and dark mode support.",
    ...
    },
    {
      id: 4,
      title: "Weather App",
      description: "A beautiful weather application with location-based forecasts, interactive maps, and detailed weather information. Includes weather alerts and historical data.",
    ...
    },
    {
      id: 5,
      title: "Blog Platform",
      description: "A modern blogging platform with rich text editor, comment system, user profiles, and SEO optimization. Supports multiple authors and content management.",
    ...
    },
    {
      ...
      description: "A responsive portfolio website showcasing projects and skills with smooth animations, contact forms, and modern design principles. Optimized for performance.",
