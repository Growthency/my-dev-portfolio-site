...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: FiLinkedin, href: 'https://linkedin.com/in/ninjamul-haque', label: 'LinkedIn' },
        ...
        <div className="py-12 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-4">
              Injamul<span className="text-blue-400">.</span>
            </h3>
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              A passionate full-stack web developer creating amazing digital experiences 
