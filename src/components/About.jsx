...
const About = () => {
  ...
  const handleResumeDownload = () => {
    ...
    const cvUrl = 'https://drive.google.com/file/d/1ujYYG7coK1mGV614nBBJJCLVxmBbHw1y/view?usp=sharing';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              Hello! I'm Injamul Haque, a dedicated web developer with expertise in modern technologies. 
              I love creating digital experiences that are not only functional but also beautiful and user-friendly.
            </p>
            <p className="text-gray-300 text-lg leading-relaxed">
              My journey in web development started with HTML and CSS, and has evolved to include advanced 
              frameworks and technologies like React, Node.js, and various databases. I'm constantly learning 
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white">Injamul Haque</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-blue-400 font-semibold">Email:</span>
                <span className="text-white">itsinjamul@gmail.com</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          >
            <div className="relative z-10">
              <img
                src="https://images.unsplash.com/photo-1549692520-acc6669e2f0c?w=600&h=400&fit=crop"
                alt="About Injamul - Developer Workspace"
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <SafeIcon icon={stat.icon} className="w-8 h-8 text-blue-400 mx-auto mb-4" />
